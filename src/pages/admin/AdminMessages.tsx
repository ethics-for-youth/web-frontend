...
import { Eye, Search, Filter, ChevronDown, MessageSquare, Phone, Mail, Calendar, Tag } from 'lucide-react';
...
const AdminMessages = () => {
  ...
  const filters: MessageFilters = useMemo(() => {
    ...
    if (selectedCategory) f.messageType = selectedCategory as any;
    if (selectedStatus) f.status = selectedStatus as any;
    if (selectedPriority) f.priority = selectedPriority as any;
    return f;
                ...
                <TableBody>
                  {filteredMessages.map((message) => (
                    <TableRow key={message.id}>
                      ...
                      <TableCell>{getCategoryLabel(message.messageType)}</TableCell>
                        ...
                        <Dialog>
                          ...
                          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Full message information and content
                              </DialogDescription>
                            </DialogHeader>
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                      ...
                                      <p className="text-sm text-foreground">{formatDate(selectedMessage.createdAt)}</p>
                                    </div>
                                    <div>
                                      <Label className="text-sm font-medium">Last Updated</Label>
                                      <p className="text-sm text-foreground">{formatDate(selectedMessage.updatedAt)}</p>
                                    </div>
                                  </div>
                                </div>
